...
gulp.task('test-modules', gulp.series(['clean-test-modules'].concat(_toConsumableArray(moduleTasks))));
...
gulp.task('closure', gulp.series([].concat(_toConsumableArray(closureTasks))));

gulp.task('default', gulp.series('closure', 'test-modules'));

gulp.task('debug', gulp.series([].concat(_toConsumableArray(debugTasks))));